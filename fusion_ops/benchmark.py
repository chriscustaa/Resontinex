...
def run_fusion_benchmark(scenarios_dir: str = "tests/golden", iterations: int = 3, output_file: str = "benchmark_results.json", verbose: bool = False) -> Dict[str, Any]:
    """High-level function to run fusion benchmarks."""
    # Create benchmark runner
    runner = FusionBenchmarkRunner(scenarios_dir)
    
    # Run all benchmarks
    results = runner.run_all_benchmarks(iterations)
